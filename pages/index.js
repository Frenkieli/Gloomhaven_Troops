...
import bgPergament from "../public/images/map.jpg";
import Script from "next/script";

console.log(bgPergament);
  ...
  return (
    <>
      ...
      >
        ...
        "
        >
          <h1 className="text-4xl md:text-7xl font-black leading-normal md:leading-normal">gloomhaven</h1>
          <h2 className="text-xl md:text-3xl font-medium leading-normal md:leading-normal">{siteNeme}</h2>
          <div 
              ref={progressRef}
            className="
